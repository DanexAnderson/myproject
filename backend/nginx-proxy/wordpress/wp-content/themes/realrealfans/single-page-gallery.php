...
-->
    ...
    <h1> Hello from Single Page Gallery </h1>
...
<!--  -->
    ...
    <div id="jssor_1" class="ml-n3 ml-md-0"style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:580px;overflow:hidden;visibility:hidden;">
        <!-- Loading Screen -->
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:480px;overflow:hidden;">
            <div>
                <img data-u="image" src="<?php bloginfo('template_url');?>/img/031.jpg" />
                <img data-u="thumb" src="<?php bloginfo('template_url');?>/img/031-s190x90.jpg" />
            </div>
            <div>
                <img data-u="image" src="<?php bloginfo('template_url');?>/img/032.jpg" />
                <img data-u="thumb" src="<?php bloginfo('template_url');?>/img/032-s190x90.jpg" />
            </div>
            <div>
                <img data-u="image" src="<?php bloginfo('template_url');?>/img/033.jpg" />
                <img data-u="thumb" src="<?php bloginfo('template_url');?>/img/033-s190x90.jpg" />
            </div>
            <div>
                <img data-u="image" src="<?php bloginfo('template_url');?>/img/034.jpg" />
                <img data-u="thumb" src="<?php bloginfo('template_url');?>/img/034-s190x90.jpg" />
            </div>
            <div>
                <img data-u="image" src="<?php bloginfo('template_url');?>/img/035.jpg" />
                <img data-u="thumb" src="<?php bloginfo('template_url');?>/img/035-s190x90.jpg" />
            </div>
            <div>
                <img data-u="image" src="<?php bloginfo('template_url');?>/img/036.jpg" />
                <img data-u="thumb" src="<?php bloginfo('template_url');?>/img/036-s190x90.jpg" />
            </div>
            <div>
                <img data-u="image" src="<?php bloginfo('template_url');?>/img/037.jpg" />
                <img data-u="thumb" src="<?php bloginfo('template_url');?>/img/037-s190x90.jpg" />
            </div>
            <div>
                <img data-u="image" src="<?php bloginfo('template_url');?>/img/038.jpg" />
                <img data-u="thumb" src="<?php bloginfo('template_url');?>/img/038-s190x90.jpg" />
            </div>
            <div>
                <img data-u="image" src="<?php bloginfo('template_url');?>/img/039.jpg" />
                <img data-u="thumb" src="<?php bloginfo('template_url');?>/img/039-s190x90.jpg" />
            </div>
            <div>
                <img data-u="image" src="<?php bloginfo('template_url');?>/img/040.jpg" />
                <img data-u="thumb" src="<?php bloginfo('template_url');?>/img/040-s190x90.jpg" />
            </div>
        </div>
        <!-- Thumbnail Navigator -->
        <div data-u="thumbnavigator" class="jssort101" style="position:absolute;left:0px;bottom:0px;width:980px;height:100px;background-color:#000;" data-autocenter="1" data-scale-bottom="0.75">
            <div data-u="slides">
                <div data-u="prototype" class="p" style="width:190px;height:90;margin-top:-30px;">
