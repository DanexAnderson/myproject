...
<div id="parent">
	<div id="child">
		...
		<div class="row ">
			...
			<div class="col-md-8 col-12 postBG shadow-sm border">
				<!-- ---------------------- Center Column ------------------------------>
						...
						<article class="post">
							...
							<?php if (has_post_thumbnail()) : ?>
								...
								<?php the_post_thumbnail('full', [
												'class' => 'shadow-sm',
												'style' => 'width:100%!important; max-width:1200px; border-top-left-radius:5px; border-top-right-radius:5px; border: 5px solid white;'
											]); ?>
							...
							<div class="content mb-5 bg-white p-5 border shadow-sm" style="border-radius: 8px;">
